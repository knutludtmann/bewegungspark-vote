  ...
  <div class="flex flex-col">
    ...
    <section class="p-8 m-3 bg-white rounded-lg">
      <h2 class="pb-2 text-2xl font-700 font-bold">
        Wie oft hast Du Lust Sport im Bewegungspark Nordkirchen zu machen?</h2>
      <div class="pb-6">Bitte die Häufigkeit auswählen.</div>
      ...
      fields: {
        skill: RadioField({
          options:[
            ...
            {
              key: 'einmal-pro-woche',
              value: 'Einmal pro Woche',
            },
            {
              key: 'einmal-im-monat',
              value: 'Einmal im Monat',
            }
          ]
        }),
      },
